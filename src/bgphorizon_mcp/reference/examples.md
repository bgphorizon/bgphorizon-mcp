...
- **Path composition answers "authorized or not".** The 18-minute announcement
...
collector. Staged migration → transient episodes. When a pattern looks clean and
simple, check it hardest.
